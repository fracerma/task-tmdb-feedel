<template>
    <div>
        <h1>Most populars movies now:</h1>
...
export default {
    ...
    created() {
        fetchServer(endpoints.popular,(res)=>{
            this.movies=res.results;
            this.total_pages=res.total_pages;
            if(this.total_pages>1) this.page=2;
            else this.page=1;
            this.handler=listenerBottom.bind(null,endpoints.popular+"&page="+this.page,this.appendMovies);
